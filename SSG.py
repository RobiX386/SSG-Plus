...
def enduranceWindow():
    ...
    bprWrap = tk.Frame(endWindow, bg="#333333")#buttons && pit info
    bprWrap.pack(side=tk.LEFT, fill=tk.Y, pady=40, padx=20)

    #PIT INFO
    
    pitInfo = tk.Frame(bprWrap, bg="#333333", highlightbackground="#424242", highlightthickness=3)
...
def sprintWindow():
    ...
    wearWrap = tk.Label(carinfo, bg="#333333")
    wearWrap.pack(fill=tk.X, side=tk.TOP, padx=20)

    wearLabel = tk.Label(wearWrap, text="Tyre Wear", bg="#333333", fg="white")
    ...
    bprWrap = tk.Frame(endWindow, bg="#333333")#buttons && pit info && race info
    bprWrap.pack(side=tk.LEFT, fill=tk.Y, pady=40, padx=20)

    #RACE INFO START

    raceinfo = tk.Frame(bprWrap, bg="#333333", highlightbackground="#424242", highlightthickness=3)
    ...
    mainButtonsWrap = tk.Frame(pcrWrap, bg="#333333")
